...
if __name__ == "__main__":
    ...
    parser.add_argument('--step_delta', required=True, type=float, help='a value to just slo')
    ...
    #one_request_latency_512 = 1.4528704595565796
    #one_request_latency_256 = 1.4033973137537639

    trace = json.load(open("H100_SD_FP16_img512_trace.json"))
