...
do
    ...
    python SD_clockwork_infer_.py --log "clockwork_request500_rate_log" --image_size 512 --rate_scale $rate_scale --cv_scale 2.0 --slo_scale 3.0
done

for cv in "0.5" "1.0" "1.5" "2.0" "2.5" "3.0" "3.5" "4.0"
do
    echo "Running with variable cv: $cv"
    python SD_clockwork_infer_.py --log "clockwork_request500_cv_log" --image_size 512 --rate_scale 0.3 --cv_scale $cv --slo_scale 3.0
done 

for slo_scale in "1.2" "1.5" "2" "3" "4" "5" "6" "7"
do
    echo "Running with variable slo: $slo_scale"
    python SD_clockwork_infer_.py --log "clockwork_request500_slo_log" --image_size 512 --rate_scale 0.3 --cv_scale 2.0 --slo_scale $slo_scale
done
