...
if __name__ == "__main__":
    ...
    RTX4090_SD_FP16_img512_trace = json.load(open("RTX4090_SD_FP16_img256_trace.json"))
    ...
    for idx in range(num_worker):
        pipes.append(StableDiffusionPipeline.from_pretrained(model_path, torch_dtype=torch.float16).to(f"cuda:4"))
    # """pipes = [        
